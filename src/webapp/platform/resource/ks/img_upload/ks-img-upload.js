                    ...
                    $.extend(me, {
                        ...
                        bindEvents: function () {
                            ...
                            $(element).find(".ks-image-pane").each(function (index, ele) {
                                ...
                                $(element).find(".ks-image-choose").on('change',function(a,b){
                            ...
                            $(element).find(".ks-image-open-button").on("click",function(){
                                $(element).find(".ks-image-choose").click();
                            })
