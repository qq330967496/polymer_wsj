...
(function () {
    ...
    angular.module('ks.pricePreview', ['ks','ks.cache'])
        .directive('ksPricePreview', ["$compile",'ksTip',function ($compile,ksTip) {
            ...
            return {
                ...
                restrict: 'E',
                templateUrl: window.webRoot + '/platform/resource/ks/price/tpl_ks_price_preview.html?version=' + window.version,
                link: function (scope, element, attrs, ngModel) {
                    ...
                    $.extend(me,{
                        ...
                        openEdit:function($target){
                            ...
                            var x0 = kx.getX($target) - kx.getX(me.$body);
                            var y0 = kx.getY($target) - kx.getY(me.$body)  + $target.height()  + me.$body[0].scrollTop;
                            me.$editor.css({
                                left:x0,
                                top:y0
                            });
                        ...
                        deleteRow:function(index){
                            ...
                            if(me.prices && me.prices.length > 0){
                                me.prices.splice(index,1);
                            }
                        },
