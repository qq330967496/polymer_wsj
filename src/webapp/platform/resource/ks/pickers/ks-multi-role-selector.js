...
(function () {
    ...
    angular.module('ks.multiRoleSelector', ['ks', 'ks.cache'])
        .directive('ksMultiRoleSelector', ["$compile", 'ksCache', function ($compile, ksCache) {
            ...
            ksCache.get("roles", window.webRoot + "/uc/privileges/picker/roles.do").then(function (data) {
            ...
            return {
                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    var promise = ksCache.get("roles", window.webRoot + "/uc/privileges/picker/roles.do").then(function (data) {
                        scope.roles = data;
                    });
