    ...
    angular.module('ks.paging', ['ks'])
        .directive('ksPaging', ['ksTip', function (ksTip) {
            return {
                ...
                '<li><a href="javascript:void(0)" class="page-index" style="height: 29px">第 ' +
                '<input   ng-keypress="pressEnter()" onkeyup="value=value.replace(/[^(\\d)]/g,1) " type="number" ng-blur="accordToPageNumQuery()" ng-model="pageNum" class="fa inPageNum" style="width:50px;"/>' +
