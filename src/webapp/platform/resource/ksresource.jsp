...
<%=com.kuaisu.platform.helper.RunModeHelper.loadCssResource(request.getContextPath(), "ksCss")%>

<%=com.kuaisu.platform.helper.RunModeHelper.loadJsResource(request.getContextPath(), "ksJs")%>

<script type="text/javascript" src="${basePath}/platform/resource/ks/charts/ks-charts-line.js?version=${version}"></script>
<script type="text/javascript" src="${basePath}/platform/resource/ks/pickers/ks-supplier-bank.js?version=${version}"></script>
